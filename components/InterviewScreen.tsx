        ...
        <div className="flex flex-col items-center gap-4">
          <button 
            ...
            className={`w-20 h-20 rounded-full flex items-center justify-center transition-colors
              ${isListening ? 'bg-orange-500 animate-pulse' : 'bg-orange-600 hover:bg-orange-500'} 
    ...
    return (
      <form onSubmit={handleSend} className="flex items-center gap-4">
        <input
          ...
          className="flex-1 bg-stone-800 border border-stone-600 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:outline-none transition"
          disabled={isLoading}
        />
        <button
          type="submit"
          disabled={isLoading || !inputText.trim()}
          className="bg-orange-600 text-white p-3 rounded-lg hover:bg-orange-500 disabled:bg-gray-700 disabled:cursor-not-allowed transition-colors"
        >
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mt-6 border-t border-stone-700 pt-6">
          ...
          <div className="flex-1">
           ...
           {recognition && (
             <button
                ...
                className={`p-3 rounded-lg transition-colors ${isVoiceMode ? 'bg-orange-600 text-white' : 'bg-gray-700 text-slate-300 hover:bg-gray-600'}`}
             >
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full mt-4 py-2 px-4 bg-orange-600 text-white rounded-lg hover:bg-orange-500 disabled:bg-gray-700 transition-colors"
        >
          Finish & Get Feedback
        </button>
      </div>
