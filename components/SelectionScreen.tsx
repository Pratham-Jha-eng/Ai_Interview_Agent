  ...
  <button
    ...
    className={`px-4 py-2 text-sm font-semibold rounded-md transition-colors ${
      active
        ...
        : 'bg-stone-700 text-slate-300 hover:bg-stone-600'
    }`}
  >
    {children}
  </button>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <div className="w-full max-w-xl">
        ...
        <div className="flex justify-center gap-2 mb-6 p-1 bg-stone-800 rounded-lg">
        ...
        <div className="min-h-[160px]">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="relative w-full max-w-sm">
                <select
                  ...
                  className="w-full appearance-none bg-stone-700 border border-stone-600 text-slate-200 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:outline-none transition cursor-pointer"
                >
              ...
              <button
                ...
                className="w-full max-w-sm px-4 py-3 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-500 transition-colors shadow-md disabled:bg-gray-700 disabled:cursor-not-allowed"
              >
                Start Interview
              </button>
            </div>
          ...
          {activeTab === 'upload' && (
             <div className="flex flex-col items-center gap-4">
              ...
              <label className="w-full max-w-sm cursor-pointer bg-stone-700 text-slate-300 rounded-lg p-4 text-center border-2 border-dashed border-stone-600 hover:border-orange-500 hover:bg-stone-600 transition-colors">
              ...
              <button onClick={handleUploadStart} disabled={!fileContent || isUploadProcessing} className="w-full max-w-sm px-4 py-3 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-500 transition-colors shadow-md disabled:bg-gray-700 disabled:cursor-not-allowed flex items-center justify-center gap-2">
